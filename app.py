...
# CONFIG
# -----------------------------
st.set_page_config(page_title="Emotion AI + Explainable AI", layout="centered")
st.title("😊 Emotion Detection + Grad-CAM")
...
def align_face(image, box):
    ...
    with mp_face_mesh.FaceMesh(static_image_mode=True) as face_mesh:
        ...
        if results.multi_face_landmarks:
            ...
            left_eye = lm[33]  # approx left eye
            right_eye = lm[263]  # approx right eye
